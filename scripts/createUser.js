...
mongooseLib.connection.once('open', function () {
    ...
    pampaUser.description += '                                                        class="btn btn-soundcloud btn-inline"><i';
    pampaUser.description += '                                                        class="icon-soundcloud"></i> Soundcloud</a>).';
    pampaUser.description += '    <br/>';
    pampaUser.description += '    <br/>';
    ...
    pampaUser.description += '   class="btn btn-twitter btn-inline"><i class="icon-twitter"></i>';
    pampaUser.description += '    follow me</a>, ';
    pampaUser.description += '<a href="https://www.facebook.com/Pampattitude"';
    pampaUser.description += '   class="btn btn-facebook btn-inline"><i class="icon-facebook"></i>';
    pampaUser.description += '    befriend me</a>, <a href="https://www.linkedin.com/pub/guillaume-delahodde/5a/751/44a/" class="btn btn-linkedin btn-inline"><i class="icon-linkedin"></i> contact me</a> or ';
    pampaUser.description += '<a href="https://www.rss.com/" class="btn btn-rss btn-inline"><i';
    pampaUser.description += 'class="icon-feed2"></i> follow the website feed</a>!';
    pampaUser.description += '<br/>';
    pampaUser.description += '    You can also <a href="mailto:pampattitude@gmail.com"';
    pampaUser.description += '                class="btn btn-mail btn-inline"><i';
    pampaUser.description += 'class="icon-mail"></i> mail me</a> for';
