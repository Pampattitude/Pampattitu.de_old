...
var cleanHtmlInput = function(html, validTags, validAttributes, callback) {
    var validTagNames = validTags || ['a', 'b', 'i', 'img', 'p', 'span', 'sub', 'sup', 'u'];
    var validAttributeNames = validAttributes || ['class', 'href', 'src'];
